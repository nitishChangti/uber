...
router.route("/profile").get(authorization("captain"), profileCaptain);

router
  .route("/getCurrentUser")
  .get(authorization("captain"), getCurrentCaptainData);

router.route("/logout").get(authorization("captain"), logOutCaptain);

router
  .route("/update-profile")
  .put(authorization("captain"), updateCaptainProfile);

router.route("/earnings").get(authorization("captain"), getCaptainEarnings);

router
  .route("/ride-history")
  .get(authorization("captain"), getCaptainRideHistory);
