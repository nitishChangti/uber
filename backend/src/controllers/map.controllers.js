...
const getCoordinates = asyncHandler(async (req, res) => {
  ...
  if (!errors.isEmpty()) {
    return res
      .status(400)
      .json(new ApiResponse(400, {}, errors.array(), false));
  }
  ...
  try {
    ...
    return res
      .status(404)
      .json(new ApiResponse(404, {}, "Unable to fetch coordinates", false));
  }
});
...
const getDistanceTime = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    const matrixResp = await axios.get(
    ...
    return res
      .status(404)
      .json(
        new ApiResponse(404, {}, "Unable to fetch distance and time", false)
      );
  }
});
...
const getCompleteSuggestions = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    return res
      .status(404)
      .json(new ApiResponse(404, {}, "Unable to fetch suggestions", false));
  }
});
