...
const ConfirmRidePopUp = ({
  ...
  const submitHander = async (e) => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        const destinationCoords = await getCoordinatesByAddress(
          ride.destination
        );
  ...
  const cancelRide = async () => {
    try {
      ...
      console.log("Unable to cancel ride");
    }
  };
  return (
      ...
      <div className="flex items-center gap-5  px-5 py-1 ">
        ...
        <div>
          <h3 className="text-xl font-semibold">
            <i className="ri-money-rupee-circle-line">{ride?.fare}</i>
          </h3>
        ...
        <form className="flex flex-col gap-3" onSubmit={submitHander}>
          ...
          <div className="flex items-center justify-between gap-5 px-2 py-1 ">
            <button
              ...
              className="w-full h-12 rounded-xl bg-emerald-400 text-xl font-semibold flex justify-center items-center"
            >
              Confirm
            </button>
            <button
              ...
              className="w-full h-12 rounded-xl bg-red-500 text-xl font-semibold"
            >
              Cancel
            </button>
          </div>
