    ...
    return (
        <div className='w-full  mt-0 py-5 flex flex-col gap-3'>
            ...
            <div className='flex items-center gap-5  px-5 py-1 '>
                ...
                <div>
                    <h3 className='text-xl font-semibold'><i className="ri-money-rupee-circle-line">{fare[vehicleType]}</i></h3>
            ...
            <button
                ...
                className='w-full h-12 rounded-xl bg-emerald-400 text-xl font-semibold'>Confirm</button>
        </div>
    )
}
