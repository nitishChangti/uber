...
class CaptainService {
    ...
    async login(email, password) {
        ...
        try {
            const response = await axios.post(`${this.baseUrl}/captains/login`, {
                email,
                password
            }, {
    ...
    async register(fullName, email, phone, password, vehicle) {
        ...
        try {
            const response = await axios.post(`${this.baseUrl}/captains/register`, {
                fullName,
                email,
                phone,
                password,
    ...
    async getCurrentCap() {
        ...
        try {
            const response = await axios.get(`${this.baseUrl}/captains/getCurrentUser`, {
    ...
    async confirmRide(rideId) {
        try {
            const response = await axios.post(`${this.baseUrl}/captains/confirmRide`, {
                rideId
            }, {
                withCredentials: true
            });
